...
export const ItemMatrixHistory = (props) => {
  ...
  const GenerateRows = (boxNumbers) => {
          ...
          boxNumbers.map((number) => {
            ...
            return (
              <Grid className="row" key={number}>
                <ItemBox key={number} boxNumber={number} status={propStatus}/>
              </Grid>
            );
          })
        }
    ...
    >
      ...
      >
        <Grid item sx={{
          marginTop: '1em', marginLeft: '2em', marginBottom: '1em',
        }}>
          <Typography 
            color="#FFF" 
            variant="subtitle1"
        ...
        <Grid item sx={{
          marginTop: '1em', marginRight: '2em', marginBottom: '1em',
          marginLeft: 'auto', 
        }}>
          <img
            alt="drone-icon"
